...
G_DEFINE_TYPE(ColumnSelectWindow, column_select, NCURSES_TYPE_WINDOW)
...
{
    // Get panel information
    ColumnSelectWindow *self = NCURSES_COLUMN_SELECT(window);
...
{
    ColumnSelectWindow *self = NCURSES_COLUMN_SELECT(object);
...
column_select_init(ColumnSelectWindow *self)
{
    ...
    window_set_window_type(NCURSES_WINDOW(self), WINDOW_COLUMN_SELECT);
